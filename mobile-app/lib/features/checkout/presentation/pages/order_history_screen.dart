...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  ...
  void _showDeleteConfirmation(BuildContext context, int orderId) {
    showDialog(
      context: context,
      builder: (dialogCtx) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pop(dialogCtx);
                context.read<OrderBloc>().add(DeleteOrderEvent(orderId));
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.redAccent,
                foregroundColor: Colors.white,
      ...
      body: BlocListener<OrderBloc, OrderState>(
        ...
        child: Builder(
          builder: (context) {
            ...
            if (_errorMsg != null && _orders.isEmpty) {
              return Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Text('Failed to load orders: $_errorMsg'),
                                ...
                                children: [
                                  if (status.toLowerCase() == 'pending' || status.toLowerCase() == 'confirmed') ...[
                                    OutlinedButton.icon(
                                      ...
                                      label: const Text('Cancel & Delete', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                    ...
                                    OutlinedButton.icon(
                                      onPressed: () => _showDeleteConfirmation(context, orderId),
