...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    super.initState();
    _fetchStatus();
    // Setup polling every 10 seconds to sync status from server
    ...
    return Scaffold(
      ...
      body: BlocBuilder<OrderBloc, OrderState>(
        builder: (context, state) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Failed to load tracking: ${state.message}'),
          ...
          return const Center(child: Text('No tracking status details available.'));
        },
      ),
    );
  }
